...
fun ProductDetailScreen(
    ...
    ProductDetailContent(
        ...
        onLessQuantity = {
            viewModel.processAction(
                ProductDetailsViewModel.UiAction.LessQuantityProduct(it)
            )
        },
        onAddToCart = { viewModelHome.processAction(HomeViewModel.UiAction.OnAddToCart(it)) },
        onLessQuantityReceipt = {
            viewModelHome.processAction(
        ...
        when (state) {
            ...
            is ProductDetailsViewModel.ProductUiState.Success -> {
                ProductDetailsContent(
                    ...
                    onLessQuantityReceipt = onLessQuantityReceipt
                )
            }
        }
    }
